  ...
  try {
    ...
    const drawUnderline = (page, startX, endX, y, options = {}) => {
      ...
      if (isNaN(startX) || isNaN(endX) || isNaN(y)) {
        ...
        console.warn("Invalid coordinates in drawUnderline (pdfService.js):", {
    ...
    const drawLabeledLine = (
      ...
      if (isNaN(safeX) || isNaN(safeY)) {
        ...
        console.warn(
          ...
          "Invalid coordinates in drawLabeledLine (pdfService.js):",
    ...
    if (meetingAttendees.isAnyoneElsePresent) {
      ...
      currentY -= 20; // Extra space after meeting attendees
    ...
    y4 = drawSectionHeader(page4, "ALTERNATE ESTATE DISTRIBUTIONS", y4 + 4);
      ...
      percentageGroups.forEach((group, idx) => {
        ...
        if (group.beneficiaries && group.beneficiaries.length > 0) {
          ...
          group.beneficiaries.forEach((beneficiary, bIndex) => {
            ...
            // Display beneficiary fields with labels like the form

            page4.drawText(`Beneficiary ${bIndex + 1}:`, {
            ...
            if (beneficiary.title) {
              ...
              page4.drawText(beneficiary.title, {
            ...
            if (beneficiary.name) {
              ...
              page4.drawText(beneficiary.name, {
